...
#***************** OPTIONAL CONFIG ***************************************************
PARENT_LABEL  = 'OrdRes'               # the XML tag for each labeled string
GROUP_LABEL   = 'OrdResCollection'                  # the XML tag for a group of strings
...
def tokenize(raw_string):
    ...
    #re_tokens = re.compile([REGEX GOES HERE], re.VERBOSE | re.UNICODE)
    # Below is copied from DataMade US Address parser.
