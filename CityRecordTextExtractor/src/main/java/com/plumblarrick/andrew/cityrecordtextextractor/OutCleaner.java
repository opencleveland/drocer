...
//not in use ... this sorting now happening at issue processor stage
...
public class OutCleaner {
    ...
    public void cleanUpFullWidth(String orderedFileName) throws
        ...
        try (BufferedReader textIn = new BufferedReader(new InputStreamReader(
                new FileInputStream(orderedFileName), "UTF-8"), 98 * 1024); Writer fileOut = new BufferedWriter(
                new PrintWriter(cleanedFileName,
                        "UTF-8"))) {
            ...
            while ((line = textIn.readLine()) != null) {
                ...
                if (line.startsWith("Ord. No. ")) {
                    ...
                    rejiggered.append(
                            "['Wide' text moved to fix flow across pages/columns] ");
